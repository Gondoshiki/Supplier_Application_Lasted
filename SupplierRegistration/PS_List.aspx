<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="PS_List.aspx.cs" Inherits="SupplierRegistration.PS_List" %>
...
<%--<asp:HiddenField ID="DateBy" runat="server" />--%>
    <!----- Loader ------------>
    ...
    <div class="container-fluid animated--grow-in">
        ...
        <!-- Page Heading -->
        <h3 class="mb-2 text-gray-800 font-weight-bold"><i class="fa-solid fa-rectangle-list"></i> All Process List</h3>
        ...
        <div class="card shadow mb-4 border-left-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-hover border" id="ListTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>APP_ID</th>
                            <th>Vendor_Name</th>
    ...
    <!-- Call .js -->
    <script src="Model/ListTable.js"></script>
</asp:Content>
